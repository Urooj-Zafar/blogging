...
export default function Categories() {
  ...
  // Scroll to blogs when category is selected
  useEffect(() => {
    if (selectedCategory && blogsSectionRef.current) {
